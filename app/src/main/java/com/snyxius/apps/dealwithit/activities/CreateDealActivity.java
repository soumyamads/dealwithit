...
//    TextView mLabel,stepViewText2;//,stepViewText2,stepViewText3;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new CreateDealStepOneFragment(), Constants.ADDBUSINESSPROFILEBASIC_FRAGMENT);
        adapter.addFragment(new CreateDealStepTwoFragment(), Constants.ADDBUSINESSPROFILEDETAIL_FRAGMENT);
        adapter.addFragment(new CreateDealStepThreeFragment(), Constants.ADDBUSINESSPROFILEDEAL_FRAGMENT);
